 ...
 * the read cache.
 */
public class SegmentReadCache implements ReadCache {
    ...
    public SegmentReadCache(ByteBufAllocator allocator, long maxCacheSize) {
        this(allocator, maxCacheSize, DEFAULT_MAX_SEGMENT_SIZE);
    }

    public SegmentReadCache(ByteBufAllocator allocator, long maxCacheSize, int maxSegmentSize) {
